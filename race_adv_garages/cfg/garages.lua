...
cfg.garage_types = {
	...
	["Importados"] = {
		...
		["i8"] = { "BMW i8",350000,30,5 },
		["p1"] = { "MacLaren P1",750000,30,5 },
		["bmwm8"] = { "BMW M8",600000,30,5 },
		["gt63s"] = { "Mercedes GT63s",1300000,40,5 },
		["bdivo"] = { "Bugatti Divo",2750000,50,5 },
		["r8pp1"] = { "Audi R8",1450000,30,5 },
		["p911r"] = { "Porsche 911",900000,30,5 },
		["c7"] = { "Corvette C7",800000,30,5 },
		["bc"] = { "Pagani Huayra BC",4900000,30,5 },
		["entityxf"] = { "Koenigsegg Agera RS",5900000,30,5 },
